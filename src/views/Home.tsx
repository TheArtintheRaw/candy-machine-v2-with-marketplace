        ...
        <MintContainer>
                    ...
                    {wallet &&
                        ...
                        Date.now() < endDate.getTime() && (
                            <Countdown
                                ...
                                onMount={({ completed }: { completed: any }) =>
            ...
            <DesContainer>
                <Des elevation={2}>
                    ...
                    <p>
                        Staking the Ghostlife Club SOLtergeists NFT will make
                        you eligible to gain Spirit/$SPRT.
                    </p>
                    <p>
                        Discounts, free Merch items, early access to future
                        limited collaboration mints and even raffle tickets for
                        NFTs/Merch/and more will be available for purchase with
                        your acquired Spirit
                    </p>
                </Des>
                <Des elevation={2}>
                    <LogoAligner>
                ...
                <Des elevation={2}>
                    ...
                    <p>
                        ...
                        We are here to be one of the pioneers in the space.
                    </p>
                    <p>
                        As the ecosystem grows it will go through constant
                        changes and ups and downs, we are prepared to endure and
                        be innovative through out these times while remaining
